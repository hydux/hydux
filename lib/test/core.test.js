                ...
                case 0:
                    counter = {
                        ...
                        actions: {
                            ...
                            down: function (_) { return function (state) { return ({ count: state.count - 1 }); }; },
                            reset: function (_) { return ({ count: 1 }); },
                            upLater: function (n) { return function (state) { return function (actions) { return [state, index_1.Cmd.ofPromise(function (n) { return new Promise(function (resolve) { return setTimeout(function () { return resolve(n); }, 10); }); }, n, actions.up)]; }; }; }
                        }
                    };
                    ctx = index_1.default({
