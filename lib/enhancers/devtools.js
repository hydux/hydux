...
function withDevtools(options) {
    options = __assign({ remote: false, hostname: 'remotedev.io', port: 443, secure: true, getActionType: function (f) { return f; }, debounce: 10, jsonToState: function (f) { return f; }, stateToJson: function (f) { return f; } }, options);
