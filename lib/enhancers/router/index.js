...
function withRouter(props) {
    ...
    return function (app) { return function (props) {
        ...
        return app(tslib_1.__assign({}, props, { init: function () {
                ...
                var cmd = cmd_1.default.batch(result[1], cmd_1.default.ofSub(function (actions) { return actions[ROUTE_ACTION](loc); }));
                ...
                history.listen(function (path) {
                    ...
                    } }, _a[ROUTE_ACTION] = function (loc) { return function (state, actions) {
                var lastLoc = pathToLoc(history.last());
                history._setLoc(loc);
                if (loc.template) {
                    var _a = index_1.runAction(routes[loc.template](loc), state, actions), nextState = _a[0], cmd = _a[1];
