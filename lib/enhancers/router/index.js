...
function mkLink(history, h) {
    ...
    return function Link(_a, children) {
        var to = _a.to, onClick = _a.onClick, _b = _a.replace, replace = _b === void 0 ? false : _b, props = __rest(_a, ["to", "onClick", "replace"]);
        ...
        return React.createElement("a", __assign({ href: to }, props, { onclick: handleClick, onClick: handleClick }), children);
    };
}
...
function parseNestedRoutes(routes) {
    function rec(routes, newRoutes) {
        ...
        newRoutes[routes.path] = __assign({}, routes, { children: children.map(function (r) { return (__assign({}, r, { parents: void 0, children: void 0 })); }) });
        children
