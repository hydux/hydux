...
function withRouter(props) {
    ...
    return function (app) { return function (props) {
        ...
        var ctx = app(tslib_1.__assign({}, props, { init: function () {
                ...
                var cmd = cmd_1.default.batch(result.cmd, cmd_1.default.ofSub(function (actions) {
                ...
                if (loc.template) {
                    ...
                    var _a = index_1.runAction(routesMap[loc.template](loc, patch), state, actions), nextState = _a.state, cmd = _a.cmd;
