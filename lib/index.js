...
function app(props) {
    ...
    return tslib_1.__assign({ 
        ...
        get state() {
            ...
            var actions = utils_1.get(paths, appActions);
            if (utils_1.get(paths, appState) && actions) {
                return render();
            }
            var _a = normalizeInit(comp.init()), state = _a[0], cmd = _a[1];
            appActions = utils_1.setDeep(paths, actions = {}, appActions);
            appState = utils_1.setDeep(paths, state, appState);
