...
export declare type ActionCmdResult<State, Actions> = [ActionState<State>, CmdType<Actions>];
export declare type NormalActionCmdResult<State, Actions> = [State, CmdType<Actions>];
export declare type NormalAction<D, S, A> = (...args: any[]) => NormalActionCmdResult<S, A>;
