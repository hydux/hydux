...
export declare const mkInit: <S, A>(state: S, cmd?: Cmd.Sub<A>[]) => () => [Partial<S>, Cmd.Sub<A>[]];
...
export declare function initAll<T extends {
    [k: string]: InitObj<any, any>;
}, A extends {
    [k: string]: any;
}>(arg: T): {
