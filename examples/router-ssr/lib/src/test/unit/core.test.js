...
var app = Hydux.app, Cmd = Hydux.Cmd, withParents = Hydux.withParents;
...
var Counter = {
    ...
    actions: {
        ...
        upObj1: function () { return function (state, actions) {
            return {
                state: { count: state.count + 1 }
            };
        }; },
        upObj2: function () { return function (state, actions) {
            return {
                cmd: Cmd.ofSub(function (_) { return setTimeout(function () { return _.upObj1(); }); })
            };
        }; },
        upObj3: function () { return function (state, actions) {
            return Cmd.ofSub(function (_) { return setTimeout(function () { return _.upObj1(); }); });
        }; },
        upObj4: function () { return function (state, actions) {
            return {
                state: { count: state.count + 1 },
                cmd: Cmd.ofSub(function (_) { return setTimeout(function () { return _.upObj1(); }); })
            };
...
describe('core api', function () {
    ...
    it('parent actions', function () {
        ...
        Hydux.overrideAction(actions, function (_) { return _.counter1.upN; }, function (n) { return function (action, parentState, parentActions) {
    ...
    it('legacy parent actions', function () {
        var initState = {
            counter1: Counter.init(),
            counter2: Counter.init(),
        };
    ...
    it('obj cmd/cmd only', function () { return __awaiter(_this, void 0, void 0, function () {
        var state, renderResult, _state, actions, ctx;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
