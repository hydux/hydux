...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_hydux_react__ = __webpack_require__("./node_modules/hydux-react/lib/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_hydux_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_hydux_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__src_index__ = __webpack_require__("../../src/index.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__utils__ = __webpack_require__("./src/client/utils.ts");
...
var view = function (state, actions) { return (__WEBPACK_IMPORTED_MODULE_0_hydux_react__["React"].createElement("div", null,
    ...
    __WEBPACK_IMPORTED_MODULE_0_hydux_react__["React"].createElement("button", { className: "down", onClick: actions.down }, "\u2013"),
    __WEBPACK_IMPORTED_MODULE_0_hydux_react__["React"].createElement("button", { className: "up", onClick: actions.up }, "+"),
    __WEBPACK_IMPORTED_MODULE_0_hydux_react__["React"].createElement("button", { className: "upLater", onClick: actions.upLater }, "+ later"))); };
...
function fetch(input, init) {
    return __WEBPACK_IMPORTED_MODULE_0_isomorphic_fetch__('http://127.0.0.1:3456' + input, init);
}
